...
public class CheckpointSys : MonoBehaviour
{
    ...
    static public float currentLap1;
        ...
        if (other.CompareTag("Checkpoint"))
        {
            ...
            else if (thisCheckpoint == end && started)
            {
                ...
                if (currentLap1 == laps)
                {
                    ...
                    {
                        print("CAR1 did not go through all checkpoints");
                    }
                }
                // If all laps are not finished, start a new lap
                else if (currentLap1 < laps)
                {
                    if (currentCheckpoint == checkpoints.Length)
                    {
                        ...
                        currentLap1++;
                        currentCheckpoint = 0;
                        print($"CAR1 Started lap {currentLap1}");
                    }
                    else
                    {
                        print("CAR1 Did not go through all checkpoints");
